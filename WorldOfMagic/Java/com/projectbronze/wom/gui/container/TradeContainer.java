...
public class TradeContainer extends Container {
	 ...
	 private TradeTileEntity te;
	    ...
	    public TradeContainer(IInventory playerInv, TradeTileEntity te) {
	        ...
	        this.addSlotToContainer(new Slot(te, 0, 41, 32));
	        this.addSlotToContainer(new OutputSlot(te, 1, 119, 32));
	        this.addSlotToContainer(new SlotLocked(te, 2, 41, 11));
	        this.addSlotToContainer(new SlotLocked(te, 3, 119, 11));
